        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative hidden sm:block">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-400 dark:focus:ring-emerald-400 transition-colors w-64"
            />
          </div>
        </div>
      </div>
